                ...
                <div class="col-sm-9">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" id="once" value="once" name="cleaning_frequency"
                                {{!empty($order[0]->cleaning_frequency) && ($order[0]->cleaning_frequency == 'once') ? 'checked' : ''}}>
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" id="weekly" value="weekly"
                               name="cleaning_frequency"
                                {{!empty($order[0]->cleaning_frequency) && ($order[0]->cleaning_frequency == 'weekly') ? 'checked' : ''}}>
                        <label class="form-check-label" for="weekly">Weekly</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" id="biweekly" value="biweekly"
                               name="cleaning_frequency"
                                {{!empty($order[0]->cleaning_frequency) && ($order[0]->cleaning_frequency == 'biweekly') ? 'checked' : ''}}>
                        <label class="form-check-label" for="biweekly">Biweekly</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" id="monthly" value="monthly"
                               name="cleaning_frequency"
                                {{!empty($order[0]->cleaning_frequency) && ($order[0]->cleaning_frequency == 'monthly') ? 'checked' : ''}}>
                ...
                <div class="col-sm-9">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" id="deep_or_spring" value="deep_or_spring"
                               name="cleaning_type"
                                {{!empty($order[0]->cleaning_type) && ($order[0]->cleaning_type == 'deep_or_spring') ? 'checked' : ''}}>
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" id="move_in" value="move_in" name="cleaning_type"
                                {{!empty($order[0]->cleaning_type) && ($order[0]->cleaning_type == 'move_in') ? 'checked' : ''}}>
                        <label class="form-check-label" for="move_in">Move in</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" id="move_out" value="move_out"
                               name="cleaning_type"
                                {{!empty($order[0]->cleaning_type) && ($order[0]->cleaning_type == 'move_out') ? 'checked' : ''}}>
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" id="post_remodeling" value="post_remodeling"
                               name="cleaning_type"
                                {{!empty($order[0]->cleaning_type) && ($order[0]->cleaning_type == 'post_remodeling') ? 'checked' : ''}}>
                ...
                <div class="col-sm-9">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" id="next_available" value="next_available"
                               name="cleaning_date"
                                {{!empty($order[0]->cleaning_date) && ($order[0]->cleaning_date == 'next_available') ? 'checked' : ''}}>
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" id="this_week" value="this_week"
                               name="cleaning_date"
                                {{!empty($order[0]->cleaning_date) && ($order[0]->cleaning_date == 'this_week') ? 'checked' : ''}}>
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" id="next_week" value="next_week"
                               name="cleaning_date"
                                {{!empty($order[0]->cleaning_date) && ($order[0]->cleaning_date == 'next_week') ? 'checked' : ''}}>
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" id="this_month" value="this_month"
                               name="cleaning_date"
                                {{!empty($order[0]->cleaning_date) && ($order[0]->cleaning_date == 'this_month') ? 'checked' : ''}}>
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" id="i_am_flexible" value="i_am_flexible"
                               name="cleaning_date"
                                {{!empty($order[0]->cleaning_date) && ($order[0]->cleaning_date == 'i_am_flexible') ? 'checked' : ''}}>
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" id="just_need_a_quote" value="just_need_a_quote"
                               name="cleaning_date"
                                {{!empty($order[0]->cleaning_date) && ($order[0]->cleaning_date == 'just_need_a_quote') ? 'checked' : ''}}>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="first_name" name="first_name"
                                   value="{{!empty($user[0]->first_name) ? $user[0]->first_name : ''}}">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="last_name">Last name</label>
                            <input type="text" class="form-control" id="last_name" name="last_name"
                                   value="{{!empty($user[0]->last_name) ? $user[0]->last_name : ''}}">
                        </div>
                        {{--The second block--}}
                        <div class="form-group col-md-8">
                            <label for="street_address">Street address</label>
                            <input type="text" class="form-control" id="street_address" name="street_address"
                                   value="{{!empty($order[0]->street_address) ? $order[0]->street_address : ''}}">
                        </div>
                        <div class="form-group col-md-4">
                            <label for="apt">Apt</label>
                            <input type="text" class="form-control" id="apt" name="apt" value="{{!empty($order[0]->apt) ? $order[0]->apt : ''}}">
                        </div>
                        {{--Tree block--}}
                        <div class="form-group col-md-6">
                            <label for="city">City</label>
                            <input type="text" class="form-control" id="city" name="city" value="{{!empty($order[0]->city) ? $order[0]->city : ''}}">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="home_footage">Home Footage</label>
                            <input type="text" class="form-control" id="home_footage" name="home_footage"
                                   value="{{!empty($order[0]->home_footage) ? $order[0]->home_footage : ''}}">
                        </div>
                        {{--Four Bock--}}
                        <div class="form-group col-md-6">
                            <label for="mobile_phone">Mobile phone</label>
                            <input type="tel" class="form-control" name="mobile_phone" id="mobile_phone"
                                   value="{{!empty($user[0]->mobile_phone) ? $user[0]->mobile_phone : ''}}">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="about_us">How did you hear about us?</label>
                            <select class="form-control" name="about_us" id="about_us">
                                <option {{!empty($order[0]->about_us) && ($order[0]->about_us == 'cleaning_for_reason' ? 'selected' : '')}} value="cleaning_for_reason">Cleaning for Reason</option>
                            </select>
                        </div>
                    </div>
                </div>
